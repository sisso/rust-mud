...
// TODO: remove login?
pub fn handle(game: &mut Game, player_id: &PlayerId, input: String) -> HandleReturn {
    match input.as_ref() {
...
pub fn handle_look(game: &Game, player_id: &PlayerId) -> HandleReturn {
...
fn execute_say(game: &Game, player_id: &PlayerId, msg: String) -> HandleReturn {
...
fn execute_move(game: &mut Game, player_id: &PlayerId, dir: &String) -> HandleReturn {
...
fn resolve_avatar_id(game: &Game, player_id: &PlayerId) -> u32 {
