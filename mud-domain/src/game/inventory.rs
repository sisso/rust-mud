...
use crate::game::item::{Item, ItemRepository, ItemId};
...
pub fn search(labels: &Labels, locations: &Locations, items: &ItemRepository, location_id: ObjId, label: &str) -> Vec<ItemId> {
...
pub fn search_one(labels: &Labels, locations: &Locations, items: &ItemRepository, location_id: ObjId, label: &str) -> Option<ItemId> {
